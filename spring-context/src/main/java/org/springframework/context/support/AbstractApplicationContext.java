...
public abstract class AbstractApplicationContext extends DefaultResourceLoader implements ConfigurableApplicationContext, DisposableBean {
    ...
    public void refresh() throws BeansException, IllegalStateException {
        synchronized (this.startupShutdownMonitor) {
            ...
            //④、验证所有必需的属性。
            logger.info("一、prepareRefresh begin...........");
            prepareRefresh();
            logger.info("一、prepareRefresh end...........");
            System.out.println();
            ...
            logger.info("三、prepareBeanFactory begin...........");
            prepareBeanFactory(beanFactory);
            logger.info("三、prepareBeanFactory end...........");
            System.out.println();

            try {
                // Allows post-processing of the bean factory in context subclasses.
                logger.info("四、postProcessBeanFactory begin...........");
                ...
                logger.info("七、initMessageSource begin...........");
                initMessageSource();
                logger.info("七、initMessageSource end...........");
                System.out.println();

                // Initialize event multicaster for this context.
                logger.info("八、initApplicationEventMulticaster begin...........");
                initApplicationEventMulticaster();
                logger.info("八、initApplicationEventMulticaster end...........");
                System.out.println();

                // Initialize other special beans in specific context subclasses.
                logger.info("九、onRefresh begin...........");
                onRefresh();
                logger.info("九、onRefresh end...........");
                System.out.println();


                // Check for listener beans and register them.
                logger.info("十、registerListeners begin...........");
                registerListeners();
                logger.info("十、registerListeners end...........");
                System.out.println();


                // Instantiate all remaining (non-lazy-init) singletons.
                logger.info("十一、finishBeanFactoryInitialization begin...........");
                finishBeanFactoryInitialization(beanFactory);
                logger.info("十一、finishBeanFactoryInitialization end...........");
                System.out.println();


                // Last step: publish corresponding event.
                logger.info("十二、finishRefresh begin...........");
                finishRefresh();
                logger.info("十二、finishRefresh end...........");
                System.out.println();
                ...
                logger.info("十三、resetCommonCaches begin...........");
                resetCommonCaches();
                logger.info("十三、resetCommonCaches end...........");
                logger.info("refresh结束");
            }
        }
    }
    ...
    protected ConfigurableListableBeanFactory obtainFreshBeanFactory() {
        //由子类AbstractRefreshableApplicationContext真正的创建DefaultLisableBeanFactory，
        //然后通过创建XmlBeanDefinitionReader加载Dom结构，将BeanDefinitions注册进BeanFactory的Map<String,BeanDefiniton>中
        //最后将创建的DefaultLisableBeanFactory赋值给AbstractApplicationFactory的子类AbstractRefreshableApplicationContext的beanFactory属性
        refreshBeanFactory();

        //获取Context维护的BeanFactory
        ConfigurableListableBeanFactory beanFactory = getBeanFactory();
        if (logger.isDebugEnabled()) {
            logger.debug("Bean factory for " + this.getClass().getSimpleName()+ ";     " + beanFactory);
        }
        return beanFactory;
    }
    ...
    protected void prepareBeanFactory(ConfigurableListableBeanFactory beanFactory) {
        ...
        logger.debug("设置beanFactory的classLoader为当前context的classLoader:" + classLoader);
    ...
    protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
        logger.debug("getBeanFactoryPostProcessors...");
    ...
    protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
        ...
        logger.debug("Instantiate all remaining (non-lazy-init) singletons");
