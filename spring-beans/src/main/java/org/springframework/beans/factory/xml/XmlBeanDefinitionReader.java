...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected int doLoadBeanDefinitions(InputSource inputSource, Resource resource) throws BeanDefinitionStoreException {
        try {
            logger.debug("Loading XML to Document...");
            Document doc = doLoadDocument(inputSource, resource);
            logger.debug("Document load end...");
            int ret = registerBeanDefinitions(doc, resource);
            return ret;
    ...
    public int registerBeanDefinitions(Document doc, Resource resource) throws BeanDefinitionStoreException {
        ...
        logger.debug("creating XmlReaderContext...");
        XmlReaderContext xmlReaderContext = this.createReaderContext(resource);
    ...
    protected BeanDefinitionDocumentReader createBeanDefinitionDocumentReader() {
        logger.debug("creating DocumentReader...");
    ...
    public XmlReaderContext createReaderContext(Resource resource) {
        //解析META-INF/spring.handlers中的命名空间
        NamespaceHandlerResolver namespaceHandlerResolver = getNamespaceHandlerResolver();
        return new XmlReaderContext(resource, this.problemReporter, this.eventListener, this.sourceExtractor, this, namespaceHandlerResolver);
    }
